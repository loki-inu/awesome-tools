...
| Open source software  | Free software       | Personally Recommended software |
|     :---------:       | :-----------------: | :----------------------------: |
| Symbol:               | Symbol:             | Symbol:                        |
|![ossoft][oss]         |![frees][free]       |🌟                              |
...
- [Bash-it](https://github.com/Bash-it/bash-it) - A full featured bash frameworks that comes with batteries and a plugin system out of the box. ![ossoft][oss]
...
- [Linux](https://linux.org) - Technically a kernel, but in this context I use it(gnu/linux) to describe the underlying system under many free and open source distributions of linux. ![ossoft][oss] 🌟

  - [Fedora](https://fedora.org) - A open source distribution built on linux, and combines both stability and the bleeding edge. ![ossoft][oss]
...
- [Introduction to programming and CS basics](https://www.youtube.com/watch?v=zOjov-2OZ0E) - A good video about the basics of CS, a great reference video.
